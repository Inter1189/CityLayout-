...
function getContentHero(Array) {
  ...
  for (let i=0; i <= Array.length-1; ++i) {
    const heroPaginationBtn = document.createElement('button');
          heroPaginationBtn.classList.add('btn__reset', 'pagination-block__button');
          ...
          heroPaginationBtn.addEventListener('click', function(){
            for (let m=0; m <= Array.length; ++m) {
              ...
              console.log(heroSectionImageWrapper.style.backgroundImage)
...
function getContentService(Array) {
  ...
  for (let i=0; i <= Array.length-1; ++i) {
    const servicePaginationBtn = document.createElement('button');
          servicePaginationBtn.classList.add('btn__reset', 'pagination-block__button');
...
function getContentPortfolio(Array) {
  ...
  for (let i=0; i <= Array.length-1; ++i) {
    const portfolioPaginationBtn = document.createElement('button');
          portfolioPaginationBtn.classList.add('btn__reset', 'pagination-block__button');
...
function createApplicationModal() {
  ...
  modalCloseBtn.classList.add('btn__reset', 'modal__close-btn');
  ...
  modalBtn.classList.add('btn__reset', 'button-consultation', 'button-consultation__modal');
